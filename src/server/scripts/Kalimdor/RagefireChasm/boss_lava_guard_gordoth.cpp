...
static const Position GordothJumpPos = { -363.5392f, 203.36604f, -22.005634f, 0.308123469352722167f };
...
struct boss_lava_guard_gordoth : public BossAI
{
    ...
    void DoAction(int32 action) override
    {
        ...
        me->SetAnimKitId(ANIMKIT_GORDOTH_NONE);
        DoCastSelf(SPELL_JAIL_BREAK);
        me->GetMotionMaster()->MoveJump(GordothJumpPos, 50.0f, 55.5477f, POINT_JUMP, true);
...
//            }
            ...
            std::list<Creature*> darkShamanResearcherList;
            ...
            {
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_1, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_1, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_2, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_2, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_3, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_3, true);
                darkShamanResearcher->CastSpell(darkShamanResearcher, SPELL_MEAT_EXPLOSION_3, true); // According to sniff
