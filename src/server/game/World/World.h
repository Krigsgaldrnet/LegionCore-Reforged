...
enum WorldBoolConfigs
{
    ...
    CONFIG_CHARACTER_TEMPLATE_ENABLED,
    ...
    CONFIG_ARGUS_IN_SKY_ENABLE,
    CONFIG_SILITHUS_WOUND_DEFAULT,
    ...
    CONFIG_RESET_CHARACTER_DB,
    CONFIG_WOW_TOKEN_ENABLED,
    CONFIG_RECRUIT_A_FRIEND_ENABLE,
    CONFIG_RECRUIT_A_FRIEND_COMMANDS_ENABLE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_WEEKLY_RESET_HOUR,
    CONFIG_WEEKLY_RESET_DAY,
