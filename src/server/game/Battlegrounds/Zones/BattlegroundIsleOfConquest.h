...
enum creaturesIC
{
    ...
    NPC_WORLD_TRIGGER_1                 = 22515,
    NPC_WORLD_TRIGGER_2                 = 23472,
};
...
enum BG_IC_NPCs
{
    ...
    BG_IC_NPC_WORLD_TRIGGER_1,
    BG_IC_NPC_WORLD_TRIGGER_2,
    BG_IC_NPC_WORLD_TRIGGER_3,
    BG_IC_NPC_WORLD_TRIGGER_4,
    BG_IC_NPC_WORLD_TRIGGER_5,
    BG_IC_NPC_WORLD_TRIGGER_6,
    BG_IC_NPC_WORLD_TRIGGER_7,
    BG_IC_NPC_WORLD_TRIGGER_8,
    BG_IC_NPC_WORLD_TRIGGER_9,
    BG_IC_NPC_WORLD_TRIGGER_10,
    BG_IC_NPC_WORLD_TRIGGER_11,
    BG_IC_NPC_WORLD_TRIGGER_12,
...
enum BG_IC_MaxSpawns
{
    ...
    MAX_NORMAL_NPCS_SPAWNS                              = BG_IC_NPC_WORLD_TRIGGER_12 + 1,
...
{    
    ...
    {BG_IC_NPC_WORLD_TRIGGER_1, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,   326.28f, -777.36f, 49.02f,  3.12f}, // 36 
    {BG_IC_NPC_WORLD_TRIGGER_2, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,   323.54f, -888.36f, 48.91f,  0.03f}, // 37
    {BG_IC_NPC_WORLD_TRIGGER_3, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,  1233.27f, -844.52f, 48.88f, -0.01f}, // 38
    {BG_IC_NPC_WORLD_TRIGGER_4, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,   397.08f, -859.38f, 48.89f,  1.64f}, // 39
    {BG_IC_NPC_WORLD_TRIGGER_5, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,  1235.53f, -683.87f, 49.30f, -3.08f}, // 40
    {BG_IC_NPC_WORLD_TRIGGER_6, NPC_WORLD_TRIGGER_1, TEAM_NEUTRAL,  1158.76f, -746.18f, 48.62f, -1.51f}, // 41
    {BG_IC_NPC_WORLD_TRIGGER_7, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL,   311.92f, -913.97f, 48.81f,  3.08f}, // 42
    {BG_IC_NPC_WORLD_TRIGGER_8, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL,   324.63f, -749.12f, 49.36f,  0.01f}, // 43
    {BG_IC_NPC_WORLD_TRIGGER_9, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL,  1236.53f, -669.41f, 48.27f,  0.10f}, // 44
    {BG_IC_NPC_WORLD_TRIGGER_10, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL, 1143.25f, -779.59f, 48.62f,  1.64f}, // 45
    {BG_IC_NPC_WORLD_TRIGGER_11, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL, 1235.09f, -857.89f, 48.91f,  3.07f}, // 46
    {BG_IC_NPC_WORLD_TRIGGER_12, NPC_WORLD_TRIGGER_2, TEAM_NEUTRAL,  425.67f, -857.09f, 48.51f, -1.60f}, // 47
};
...
{
    {11.69f, 0.03f, 20.62f, 3.21f},
    {7.30f, -0.09f, 34.51f, 3.15f}
};
...
const ICGo BG_IC_ObjSpawnlocs[MAX_NORMAL_GAMEOBJECTS_SPAWNS] =
{
    ...
    {BG_IC_GO_HORDE_GATE_2, GO_HORDE_GATE_2, 1217.9f, -676.948f, 47.6341f, 1.5708f}, // Horde Gate || Right
    {BG_IC_GO_HORDE_GATE_3, GO_HORDE_GATE_3, 1218.74f, -851.155f, 48.2533f, -1.5708f}, // Horde Gate || Left    
...
struct ICNodePoint
{
    ...
    WorldStates worldStates[5]; // the worldstates that represent the node in the map
    ICNodeState nodeState;
};

const ICNodePoint nodePointInitial[7] =
{
    {BG_IC_GO_REFINERY_BANNER, GO_REFINERY_BANNER, TEAM_NEUTRAL, NODE_TYPE_REFINERY, {GO_ALLIANCE_BANNER_REFINERY, GO_ALLIANCE_BANNER_REFINERY_CONT, GO_HORDE_BANNER_REFINERY, GO_HORDE_BANNER_REFINERY_CONT                    }, false, 0, 0, {WorldStates::BG_IC_REFINERY_UNCONTROLLED, WorldStates::BG_IC_REFINERY_CONFLICT_A, WorldStates::BG_IC_REFINERY_CONFLICT_H, WorldStates::BG_IC_REFINERY_CONTROLLED_A, WorldStates::BG_IC_REFINERY_CONTROLLED_H}, NODE_STATE_UNCONTROLLED},
    {BG_IC_GO_QUARRY_BANNER, GO_QUARRY_BANNER, TEAM_NEUTRAL, NODE_TYPE_QUARRY, {GO_ALLIANCE_BANNER_QUARRY, GO_ALLIANCE_BANNER_QUARRY_CONT, GO_HORDE_BANNER_QUARRY, GO_HORDE_BANNER_QUARRY_CONT                                  }, false, 0, 0, {WorldStates::BG_IC_QUARRY_UNCONTROLLED, WorldStates::BG_IC_QUARRY_CONFLICT_A, WorldStates::BG_IC_QUARRY_CONFLICT_H, WorldStates::BG_IC_QUARRY_CONTROLLED_A, WorldStates::BG_IC_QUARRY_CONTROLLED_H}, NODE_STATE_UNCONTROLLED},
    {BG_IC_GO_DOCKS_BANNER, GO_DOCKS_BANNER, TEAM_NEUTRAL, NODE_TYPE_DOCKS, {GO_ALLIANCE_BANNER_DOCK, GO_ALLIANCE_BANNER_DOCK_CONT, GO_HORDE_BANNER_DOCK, GO_HORDE_BANNER_DOCK_CONT                                             }, false, 0, 0, {WorldStates::BG_IC_DOCKS_UNCONTROLLED, WorldStates::BG_IC_DOCKS_CONFLICT_A, WorldStates::BG_IC_DOCKS_CONFLICT_H, WorldStates::BG_IC_DOCKS_CONTROLLED_A, WorldStates::BG_IC_DOCKS_CONTROLLED_H}, NODE_STATE_UNCONTROLLED},
    {BG_IC_GO_HANGAR_BANNER, GO_HANGAR_BANNER, TEAM_NEUTRAL, NODE_TYPE_HANGAR, {GO_ALLIANCE_BANNER_HANGAR, GO_ALLIANCE_BANNER_HANGAR_CONT, GO_HORDE_BANNER_HANGAR, GO_HORDE_BANNER_HANGAR_CONT                                  }, false, 0, 0, {WorldStates::BG_IC_HANGAR_UNCONTROLLED, WorldStates::BG_IC_HANGAR_CONFLICT_A, WorldStates::BG_IC_HANGAR_CONFLICT_H, WorldStates::BG_IC_HANGAR_CONTROLLED_A, WorldStates::BG_IC_HANGAR_CONTROLLED_H}, NODE_STATE_UNCONTROLLED},
    {BG_IC_GO_WORKSHOP_BANNER, GO_WORKSHOP_BANNER, TEAM_NEUTRAL, NODE_TYPE_WORKSHOP, {GO_ALLIANCE_BANNER_WORKSHOP, GO_ALLIANCE_BANNER_WORKSHOP_CONT, GO_HORDE_BANNER_WORKSHOP, GO_HORDE_BANNER_WORKSHOP_CONT                    }, false, 0, 0, {WorldStates::BG_IC_WORKSHOP_UNCONTROLLED, WorldStates::BG_IC_WORKSHOP_CONFLICT_A, WorldStates::BG_IC_WORKSHOP_CONFLICT_H, WorldStates::BG_IC_WORKSHOP_CONTROLLED_A, WorldStates::BG_IC_WORKSHOP_CONTROLLED_H}, NODE_STATE_UNCONTROLLED},
    {BG_IC_GO_ALLIANCE_BANNER, GO_ALLIANCE_BANNER, TEAM_ALLIANCE, NODE_TYPE_GRAVEYARD_A, {GO_ALLIANCE_BANNER_GRAVEYARD_A, GO_ALLIANCE_BANNER_GRAVEYARD_A_CONT, GO_HORDE_BANNER_GRAVEYARD_A, GO_HORDE_BANNER_GRAVEYARD_A_CONT    }, false, 0, 0, {WorldStates::BG_IC_ALLIANCE_KEEP_UNCONTROLLED, WorldStates::BG_IC_ALLIANCE_KEEP_CONFLICT_A, WorldStates::BG_IC_ALLIANCE_KEEP_CONFLICT_H, WorldStates::BG_IC_ALLIANCE_KEEP_CONTROLLED_A, WorldStates::BG_IC_ALLIANCE_KEEP_CONTROLLED_H}, NODE_STATE_CONTROLLED_A},
    {BG_IC_GO_HORDE_BANNER, GO_HORDE_BANNER, TEAM_HORDE, NODE_TYPE_GRAVEYARD_H, {GO_ALLIANCE_BANNER_GRAVEYARD_H, GO_ALLIANCE_BANNER_GRAVEYARD_H_CONT, GO_HORDE_BANNER_GRAVEYARD_H, GO_HORDE_BANNER_GRAVEYARD_H_CONT             }, false, 0, 0, {WorldStates::BG_IC_HORDE_KEEP_UNCONTROLLED, WorldStates::BG_IC_HORDE_KEEP_CONFLICT_A, WorldStates::BG_IC_HORDE_KEEP_CONFLICT_H, WorldStates::BG_IC_HORDE_KEEP_CONTROLLED_A, WorldStates::BG_IC_HORDE_KEEP_CONTROLLED_H}, NODE_STATE_CONTROLLED_H},
};
...
{
    friend class BattlegroundIsleOfConquest;
...
class BattlegroundIsleOfConquest : public Battleground
{
    public:
    ...
    private:
        ...
        uint16 factionReinforcements[MAX_TEAMS];
        ...
        WorldStates GetWorldStateFromGateEntry(uint32 id, bool open)
        {
            WorldStates uws = WorldStates::WS_NONE;

            switch (id)
            {
                case GO_HORDE_GATE_1:
                    uws = (open ? WorldStates::BG_IC_GATE_FRONT_H_WS_OPEN : WorldStates::BG_IC_GATE_FRONT_H_WS_CLOSED);
                    break;
                case GO_HORDE_GATE_2:
                    uws = (open ? WorldStates::BG_IC_GATE_WEST_H_WS_OPEN : WorldStates::BG_IC_GATE_WEST_H_WS_CLOSED);
                    break;
                case GO_HORDE_GATE_3:
                    uws = (open ? WorldStates::BG_IC_GATE_EAST_H_WS_OPEN : WorldStates::BG_IC_GATE_EAST_H_WS_CLOSED);
                    break;
                case GO_ALLIANCE_GATE_3:
                    uws = (open ? WorldStates::BG_IC_GATE_FRONT_A_WS_OPEN : WorldStates::BG_IC_GATE_FRONT_A_WS_CLOSED);
                    break;
                case GO_ALLIANCE_GATE_1:
                    uws = (open ? WorldStates::BG_IC_GATE_WEST_A_WS_OPEN : WorldStates::BG_IC_GATE_WEST_A_WS_CLOSED);
                    break;
                case GO_ALLIANCE_GATE_2:
                    uws = (open ? WorldStates::BG_IC_GATE_EAST_A_WS_OPEN : WorldStates::BG_IC_GATE_EAST_A_WS_CLOSED);
                    break;
            }
