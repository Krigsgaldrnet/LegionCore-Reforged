...
void WorldSession::HandleSendMail(WorldPackets::Mail::SendMail& packet)
{
    ...
    TC_LOG_INFO("network", "Player %u includes %zu items, " UI64FMTD " copper and " UI64FMTD " COD copper with stationery = %u", player->GetGUIDLow(), packet.Info.Attachments.size(), packet.Info.SendMoney, packet.Info.Cod, packet.Info.StationeryID);
    ...
    {
        TC_LOG_INFO("network", "Player %u is sending mail to %s (GUID: not existed!) with subject %s and body %s includes %zu items, " UI64FMTD " copper and " UI64FMTD " COD copper with stationery = %u",
    ...
    TC_LOG_INFO("network", "Player %u is sending mail to %s (GUID: %u) with subject %s and body %s includes %zu items, " UI64FMTD " copper and " UI64FMTD " COD copper with stationery = %u",
